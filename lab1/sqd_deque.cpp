...
#include"Character.h"
#include"Serie.h"
template class sqd_deque<int>;
template class sqd_deque<double>;
template class sqd_deque<string>;
template class sqd_deque<Book>;
template class sqd_deque<Character>;
template class sqd_deque<Serie>;
