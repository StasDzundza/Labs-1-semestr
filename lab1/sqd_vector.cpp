...
#include"Character.h"
#include"Serie.h"
template class sqd_vector<int>;
template class sqd_vector<double>;
template class sqd_vector<string>;
template class sqd_vector<Book>;
template class sqd_vector<Character>;
template class sqd_vector<Serie>;
template<typename T>
T sqd_vector<T>::back()
{
	if (VECTOR.size() > 0)
