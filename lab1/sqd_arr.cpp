...
#include"Character.h"
#include"Serie.h"
template class sqd_arr<int>;
template class sqd_arr<double>;
template class sqd_arr<string>;
template class sqd_arr<Book>;
template class sqd_arr<Character>;
template class sqd_arr<Serie>;
